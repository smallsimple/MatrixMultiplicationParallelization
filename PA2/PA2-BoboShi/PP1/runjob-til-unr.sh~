...
echo "--------------------------------------------------------------"; echo " "
gcc -O3 -fopenmp PA2-Prob1-til.c -lm; ./a.out > R1-ikj-tilIK-256-256-gcc.txt

echo " "; echo "--------------------------------------------------------------"
echo "Programming Assignment 2, Problem 1, ICC"
echo "--------------------------------------------------------------"; echo " "
icc -fast -openmp PA2-Prob1-til.c -lm; ./a.out >R1-ikj-tilIK-256-256-icc.txt
...
cp R1-ikj-tilIK-256-256-gcc.txt R1-ikj-tilIK-256-256-icc.txt $INP/
rm -rf $TMPDIR
