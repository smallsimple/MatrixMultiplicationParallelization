...
#
INP=$HOME/PA2/PP1
cp $INP/PA2-Prob1-bobo.c .
#cp $HOME/PA2/PA2-Prob2.c .

echo " "; echo "--------------------------------------------------------------"
echo "Programming Assignment 2, Problem 1, GCC"
echo "--------------------------------------------------------------"; echo " "
gcc -O3 -fopenmp PA2-Prob1-bobo.c -lm; ./a.out > R1-ikj-gcc.txt

echo " "; echo "--------------------------------------------------------------"
echo "Programming Assignment 2, Problem 1, ICC"
echo "--------------------------------------------------------------"; echo " "
icc -fast -openmp PA2-Prob1-bobo.c -lm; ./a.out >R1-ikj-icc.txt
...
cp R1-ikj-gcc.txt R1-ikj-icc.txt $INP/
rm -rf $TMPDIR
