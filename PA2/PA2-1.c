// Template for PA2 Problem 1
// Use gcc -O3 -fopenmp PA2-Prob1.c ; ./a.out
//
// Use N=512 to accelerate testing and refinement and N=2048 for reporting final results
#include <omp.h>
#include <unistd.h>
#include <sys/time.h>
// #define N (2048)
...
// Make suitable changes to create parallel version
  {
     if (omp_get_thread_num()==0) printf("Starting with thrds=%d\n",nt);
